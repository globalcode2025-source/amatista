...
const LINKS = [
  ...
  { to: '/admin/galeria', label: 'Galería', end: false, icon: 'grid' },
  { to: '/admin/testimonios', label: 'Testimonios', end: false, icon: 'users' },
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-sm border-l-2 px-3 py-2.5 text-sm transition-colors ${
                isActive ? 'border-gold bg-cream/10 text-gold-light' : 'border-transparent text-cream/70 hover:bg-cream/5 hover:text-cream'
              }`
            }
          >
            <svg
